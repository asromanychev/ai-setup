...
| 20 | Все существующие тесты остаются зелёными (верифицируется в шаге 5) | AC 18 |
...
**Pass criteria:** exit 0, 0 failures, pending совпадает со значением из шага 2.
...
- `started_at`: 2026-04-06T20:10:00+03:00
- `finished_at`: 2026-04-06T20:15:00+03:00
- `elapsed_seconds`: 300
