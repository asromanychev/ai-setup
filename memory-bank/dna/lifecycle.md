...
3. **README sync.** Добавлен/удалён/переименован документ — обнови parent README или `index.md`.
...
- [ ] для документов issues/ задан `delivery_status`, для adr/ — `decision_status`
- [ ] parent README или `index.md` обновлён при изменении состава или reading order
